...
From this we can take the example of the word "page" which has the word_id 6. This corresponds to the set[1,2]
which corresponds to the both the urls http://localhost:8090/link and http://localhost:8090.
This means that the word is contained in both pages which is correct since we can see that in our 
lexicons and directly on the webpages if we compare them. Therefore, our test is successful.
