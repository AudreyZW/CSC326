...
From this we can take the example of the word "page" which has the word_id 6. This corresponds to the set[1,2], which corresponds to both the urls http://localhost:8090/link and http://localhost:8090.
